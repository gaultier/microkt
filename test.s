...
## %bb.0:
	...
	movl	$0, -4(%rbp)
Ltmp0:
	.loc	1 4 9 prologue_end      ## /tmp/test.c:4:9
	movl	$4, -8(%rbp)
	.loc	1 6 18                  ## /tmp/test.c:6:18
	movl	-8(%rbp), %esi
	.loc	1 6 5 is_stmt 0         ## /tmp/test.c:6:5
	leaq	L_.str(%rip), %rdi
	movb	$0, %al
	callq	_printf
	xorl	%ecx, %ecx
	movl	%eax, -12(%rbp)         ## 4-byte Spill
	.loc	1 8 5 is_stmt 1         ## /tmp/test.c:8:5
	movl	%ecx, %eax
	addq	$16, %rsp
	popq	%rbp
	retq
...
Linfo_string:
	...
	.asciz	"/tmp/test.c"           ## string offset=48
	.asciz	"/Users/pgaultier/code/compiler" ## string offset=60
	.asciz	"main"                  ## string offset=91
	.asciz	"int"                   ## string offset=96
	.asciz	"a"                     ## string offset=100
